    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'Admin'), ('user', 'User')], default='user', max_length=20, verbose_name='Роль')),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=('subscriber', 'subscription'), name='Уникальная запись подписчик - автор'),
        ),
    ]
